 ...
 * ============= SOURCE =============
 * 
 * https://github.com/ConnorLinfoot/BountifulAPI/blob/master/src/main/java/com/connorlinfoot/bountifulapi/BountifulAPI.java
 * 
 * ALl credits go to ConnorLinfoot and BountifulAPI
 */
...
public class BountifulAPI {
    ...
    public static void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            ...
            }.runTaskLater(Gamet.instance, duration + 1);
        }
        ...
        while (duration > 60) {
            ...
            }.runTaskLater(Gamet.instance, (long) sched);
        }
    }
