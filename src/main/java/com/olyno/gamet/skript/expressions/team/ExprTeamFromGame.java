...
public class ExprTeamFromGame extends SimpleExpression<Team> {
    ...
    protected Team[] get( Event e ) {
        ...
        if (!t.replaceAll(" ", "").equals("")) {
            ...
            Gamet.error("A team can't have a empty name (Current name: \"" + team.getSingle(e) + "\")");
            return null;
        }
    }
                ...
                switch (mode) {
                    case SET:
                        if (obj instanceof Player) {
                            ...
                            Gamet.error("You can add only points or player to a team, not a " + obj.getClass());
                        }
                        break;
                    case ADD:
                        if (obj instanceof Player) {
							...
							if (team.getMaxPlayer() > team.getPlayers().size()) {
								...
								Gamet.error("The team \"" + team.getName() + "\" can't add more players, you have already " + team.getPlayers().size() + " players in this team and the maximum of players is " + team.getMaxPlayer());
                            }
                        } else if (obj instanceof Point) {
                            Point point = (Point) obj;
                            point.setTeam(team);
    ...
    public String toString( Event e, boolean debug ) {
        return "the team \"" + team.toString(e, debug) + "\" from the game \"" + game.toString(e, debug) + "\"";
    }
